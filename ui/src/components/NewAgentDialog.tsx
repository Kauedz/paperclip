          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Recomendamos deixar seu CEO lidar com a configuração do agente — eles conhecem a
                  estrutura organizacional e podem configurar relatórios, permissões e
                  adaptadores.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                >
                  Quero configuração avançada eu mesmo
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Escolha seu tipo de adaptador para configuração avançada.
                </p>
              </div>
