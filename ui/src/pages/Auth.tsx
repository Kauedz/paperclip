      ...
      <div className="w-full md:w-1/2 flex flex-col overflow-y-auto">
        <div className="w-full max-w-md mx-auto my-auto px-8 py-12">
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-sm font-medium">Althius ALG</span>
          </div>

          <h1 className="text-xl font-semibold">
            {mode === "sign_in" ? "Entrar na Althius ALG" : "Criar sua conta Althius ALG"}
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "sign_in"
              ? "Use seu e-mail e senha para acessar esta instância."
              : "Crie uma conta nesta instância. Confirmação de e-mail não é necessária."}
          </p>
